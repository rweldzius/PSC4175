...
![](https://github.com/rweldzius/PSC4175/raw/main/content/figures/condmean.png)
...
require(tidyverse)
require(plotly)
sc_debt <- read_rds('https://github.com/rweldzius/PSC4175/raw/main/static/data/sc_debt.Rds')
```

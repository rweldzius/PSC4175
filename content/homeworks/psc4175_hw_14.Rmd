...
**NB**: You will have to Knit this as a HTML file since Plotly does not work when knitted as a PDF. After you knit your HTML, open the file and then print as a PDF. Now onto the homework! 
...
**Quick Exercise 1** Do a new clustering with 4 centroids called `florida.me` and look at the contests of each cluster using tidy:
...
**Quick Exercise 2**  Now implement this! What do you observe? Were you correct?
...
```{r}
dat.all <- read_rds(file="https://github.com/rweldzius/PSC4175/raw/main/static/data/CountyVote2004_2020.Rds")
...
Hey, guess what?! That's it for new material. You're done! Congratulations on making it this far!
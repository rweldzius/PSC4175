...
The final grade is calculated as a weighted average of these components with the following weights:
  ...
  * **Homeworks** (35 points): There are 14 homeworks over the semester. Each will be worth between 1 and 3 points depending on their length/difficulty (total 35 points). Due on Tuesdays by 11:59pm. 

...
The final grade is calculated as a weighted average of these components with the following weights:
  ...
  * **Homeworks**: There are 15 homeworks over the semester. Each will be worth 2 points (total 30 points). Due on Tuesdays by 10:00pm. 

  * **Problem sets**: 8 in total worth 6 points each. Only 7 will be graded. There will be one extra credit point available in each of the problem sets. 7 problem sets: 42 total points (42% of your final grade). But, there are also 7 extra credit points available (+7 points) and I will still count the ungraded problem set as extra credit (+7 points). 
  ...
  * **Attendance & Participation**: Worth 8 points (0.5 points per Thursday class). You are required to show up to our Thursday classes and participate. 
...
| pset7 | 6% | 6 | 1 | 7 |
| pset8 | 0% | 0 | 7 | 7 |
| Homeworks | 30% | 30 | 0 | 30 |
| Final Project | 20% | 20 | 0 | 20 |
| Attendance/Participation | 8% | 8 | 0 | 8 |
| **Totals** | **100%** | **100** | **14** | **114** |
